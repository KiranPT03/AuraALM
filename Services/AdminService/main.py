...
from scripts.router import organization_router
from scripts.utils.logger import log
from scripts.config.application import config
from scripts.router.user_router import user_router
from scripts.router.organization_router import organization_router



def subscribe_routes(app):
    app.include_router(user_router, prefix="/automator/api/v1/admin")
    app.include_router(organization_router, prefix="/automator/api/v1/admin")
